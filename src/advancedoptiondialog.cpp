...
AdvancedOptionDialog::AdvancedOptionDialog(RequestInfo* requestInfo,
                                           QWidget* parent)
    : QDialog(parent),
      ui(new Ui::AdvancedOptionDialog),
  ...
  connect(this, SIGNAL(requestInfoChanged(RequestInfo*)), parent,
          SLOT(updateRequestInfo(RequestInfo*)));
